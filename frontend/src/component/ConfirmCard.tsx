...
const ConfirmCard: React.FC<ConfirmCardProps> = ({userById, userImage , userName, fullName}) => {
  return (
    <Link to={`/profile/${userById}`} className="flex width90 m-auto pt-2 border-2 bg-gray-50 border-gray-100 overflow-hidden pb-2 rounded-xl mb-2 dark:bg-gray-700 dark:text-white">
