          ...
          <div className="relative top-0 h-full max-md:hidden">
            <div className=" overflow-y-scroll scroll-none p-2 sticky top-20">
              <div className="flex-col items-start justify-center bg-white dark:bg-black dark:text-white mt-1 story-shadow-all overflow-y-auto scroll-none rounded-2xl transition-max-height duration-300 ease-in-out" style={collapseStyle2 == 1 ? { height: '450px' } : { height: '88px' }}>
                ...
                <RequestCard userImage="https://randomuser.me/api/portraits/women/20.jpg" userName="Khushi Agrawal"/>
                <RequestCard userImage="https://randomuser.me/api/portraits/women/21.jpg" userName="Poornima"/>
                <RequestCard userImage="https://randomuser.me/api/portraits/women/32.jpg" userName="Daaket"/>
                <RequestCard userImage="https://randomuser.me/api/portraits/women/44.jpg" userName="Kiran"/>
                <RequestCard userImage="https://randomuser.me/api/portraits/women/55.jpg" userName="Vadehi"/>
              </div>
              {/* Confirm friends---- */}
